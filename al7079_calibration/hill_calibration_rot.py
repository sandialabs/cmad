...
p_hill_learned = np.r_[np.array(Y), np.ones(6)]
params = params_hill_voce(p_elastic, p_hill_learned, p_voce)
...
objective = Objective(qoi, gradient_type="adjoint", weights = weights_time)
